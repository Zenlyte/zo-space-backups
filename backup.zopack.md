...
const PROJECTS = [
  ...
  { name: "OpenClaw Dashboard", desc: "Management interface for OpenClaw multi-machine agent orchestration and distributed AI workloads.", status: "in-progress", tags: ["Infra", "AI", "Distributed"], link: null },
  { name: "Skill Gallery", desc: "Gallery for published Zo skills and community contributions.", status: "in-progress", tags: ["Zo Space", "Community"], link: null },
      ...
      <div className="min-h-screen text-white font-body relative overflow-hidden" style={{ background: COLORS.bg }}>
        ...
        <footer className="relative z-10 py-8" style={{ borderTop: `1px solid ${COLORS.border}` }}>
          <div className="max-w-7xl mx-auto px-6 flex flex-wrap items-center justify-between gap-4">
            <p className="text-xs font-mono tracking-wider" style={{ color: COLORS.dimmed }}>© 2026 Zenlyte</p>
...
// Query Zo API for real agent data
